...
{
    public partial class SimpleConfigurationForm : Form
    {
        public SimpleConfigurationForm()
        {
            InitializeComponent();
            ...
            AdvancedModeButton.Text = Language.Get("SettingsButton_AdvancedMode", "Advanced Mode");
        ...
        {
            if (acf == null || acf.IsDisposed) acf = new SimpleAlertConfigurationForm();
            acf.Show();
            acf.Activate();
        }
