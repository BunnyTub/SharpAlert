...
namespace SharpAlert
{
    public partial class ShareAlertsForm : Form
    {
        ...
        private async void ShareAlertsForm_Load(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Your router doesn't appear to have UPnP or NAT-PMP available. To use peer-to-peer sharing, turn on UPnP or NAT-PMP in your router settings.", Text,
