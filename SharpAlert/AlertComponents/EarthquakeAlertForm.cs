...
{
    public partial class EarthquakeAlertForm : Form
    {
        ...
        private void AlertForm_Shown(object sender, EventArgs e)
        {
            ...
            PlayFromUnmanagedSource(Resources.earthquake_alert, true);
            ...
            OutlineContainerPanel.BackColor = ColorSubtitleOnlyOne;
        ...
        private void WindowFlash_Tick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                OutlineContainerPanel.BackColor = ColorSubtitleOnlyTwo;
                //if (AlertsQueued != 0)
                //{
