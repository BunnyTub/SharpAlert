...
using System.Text;
using SharpEncoder.Models;

namespace SharpEncoder
{
    public static class EASEncoder
    {
        ...
        private static readonly SAMEAudioBit Mark = new SAMEAudioBit(646, (decimal)0.00192);
        private static readonly SAMEAudioBit Space = new SAMEAudioBit(1033, (decimal)0.00192);
        ...
        public static MemoryStream CreateNewMessageFromRawData(string message)
        {
        ...
        private static MemoryStream GenerateWavStream()
        {
